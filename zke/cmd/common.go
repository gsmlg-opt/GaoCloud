...
func ClusterInitForGaoCloud(ctx context.Context, zkeConfig *types.ZKEConfig, zkeFullState *core.FullState, dialersOptions hosts.DialersOptions) (*core.FullState, error) {
	log.Infof(ctx, "Initiating Kubernetes cluster")
	var fullState *core.FullState
	kubeCluster, err := core.InitClusterObject(ctx, zkeConfig)
	if err != nil {
